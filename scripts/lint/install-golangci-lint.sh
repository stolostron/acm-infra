...
# Centralized golangci-lint installation script
# This script can be sourced or executed directly from any repository.
#
# Usage:
#   Direct execution:
...
#     GOLANGCI_LINT_VERSION=v2.5.0 bash install-golangci-lint.sh
#
###############################################################################
